...
namespace QuanLyBanBida
{
    public partial class AdminAccount : Form
    {
        ...
        private void dtgv_Account_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var selectedRow = dtgv_Account.Rows[index];
            txt_Display.Text = selectedRow.Cells[0].Value.ToString();
            txt_nameaccount.Text = selectedRow.Cells[1].Value.ToString();
            txtPasswordaccount.Text = selectedRow.Cells[2].Value.ToString();
